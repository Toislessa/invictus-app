...
def main():
    ...
    multiplos_14_before = [[] for _ in range(400)]  # Lista para armazenar os horários um minuto antes dos múltiplos de 14
    multiplos_14_after = [[] for _ in range(400)]  # Lista para armazenar os horários um minuto depois dos múltiplos de 14
