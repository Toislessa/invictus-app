...
def main():
    ...
    multiplos_14 = [[] for _ in range(600)]  # Lista para armazenar os múltiplos de 14
    pagou = [[] for _ in range(600)]  # Lista para armazenar as mensagens de pagamento
    ...
    columns = [str(i) for i in range(14, 600, 14)]  # Cria uma lista com os nomes das colunas
