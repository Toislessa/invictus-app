...
def main():
    ...
    multiplos_14 = [[] for _ in range(200)]  # Lista para armazenar os múltiplos de 14
    pagou = [[] for _ in range(200)]  # Lista para armazenar as mensagens de pagamento
        ...
        for resultado in resultados:
            ...
            if roll == 0:
                ...
                if created_at_str in multiplos_14_dict:
                        pagou[multiplos_14_dict[created_at_str]].append(f"P {created_at_str}")
